...
/// An abstract base class which can be subclassed to generate iterators for conatiner
/// classes. Under normal circumstances, a user of libLCS will not use this class directly.
template <class T>
class Iterator
{
public:
    ...
    /// iteration. Returns \p true if yes, \p false if not.
