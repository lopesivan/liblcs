...
/// A template class which encapsulates a logical NOR gate. The template parameter
...
public:
    ...
    /// Here, a NOR operation is performed on the line states of the data lines of the
...
template <int width>
Nor<width>::Nor(const Bus<1> &output, const InputBus<width> &input)
