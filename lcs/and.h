...
public:
    ...
    /// Here, an AND operation is performed on the line states of the data lines of the
...
template <int width>
And<width>::And(const Bus<1>& output, const InputBus<width> &in)
