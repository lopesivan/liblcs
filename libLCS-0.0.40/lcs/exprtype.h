...
/// An enumeration which enumerates types for the various kinds of operations which can
/// be used in an expression performing operations on lcs::InputBus (and hence, lcs::Bus)
/// objects.
enum ExprType
{
