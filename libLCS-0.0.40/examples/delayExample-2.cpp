...
int main()
{
	...
	// Initialising an AND gate with a propogation delay of 
	...
	// the two AND gates.
	ChangeMonitor<> output1(s1, "Output 1");
	ChangeMonitor<> output2(s2, "Output 2");
	
	// Initialising a tester object to feed input to the above
	// AND gates at every change in clock state.
	Tester<2> tester((a,b));
